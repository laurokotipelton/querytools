...
begin
	...
	DELETE FROM VENDA_CONSOLIDADA_PRODUTO WHERE LOJCOD = L AND VCPDAT BETWEEN D1 AND D2;
	DELETE FROM VENDA_CONSOLIDADA_FINALIZADORA WHERE LOJCOD = L AND VCFDAT BETWEEN D1 AND D2;
	DELETE FROM VENDA_CONSOLIDADA_LOJA WHERE LOJCOD = L AND VCLDAT BETWEEN D1 AND D2;
	...
	SELECT NEXTVAL('SQ_VENDA_CONSOLIDADA_PRODUTO')
	  ...
	  JOIN ITEM_VENDA IV ON (T.TRNSEQ  = IV.TRNSEQ
	                    ...
	                    AND  IV.ITVTIP = '1')
	WHERE T.TRNTIP = '1' AND T.LOJCOD = L AND T.TRNDAT BETWEEN D1 AND D2
	...
	SELECT NEXTVAL('SQ_VENDA_CONSOLIDADA_LOJA')
	 ...
	 WHERE T1.TRNTIP = '1' AND T1.LOJCOD = L AND T1.TRNDAT BETWEEN D1 AND D2
